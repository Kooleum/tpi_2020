...
foreach ($requests as $request) {
    ...
    $datas .= "<td class=\"align-middle\">" . $emergencyLevel[$request['levelRequest']] . "</td>";
    $datas .= "<td class=\"align-middle\">" . $status[$request['statusRequest']] . "</td>";
    $datas .= "<td class=\"align-middle\"><a href='?action=requestDetails&idRequest=" . $request['idRequest'] . "'><button class='btn btn-success'>Voir les détails</button></a></td>";
    $datas .= "</tr>";
}
